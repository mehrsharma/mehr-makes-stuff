...
export default function About() {
  return (
    <Container component="div" sx={{ display: "flex", justifyContent: "left", backgroundColor: Colors.lightGreen, padding: "20px", flexDirection: "column"}} maxWidth = {false} id="about">
